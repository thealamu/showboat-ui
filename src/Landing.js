...
export default function Landing() {
	...
	return (
		<>
			<section id="header">
				<div className="right">
					<Button onClick={openAuth} id="headerlogin" color="secondary">Login</Button>
					<Button onClick={openAuth} variant="contained" size="small" color="secondary">Create an Account</Button>
				</div>
				<div id="headercontainer">
					...
					<div id="headercharge">
						...
						<Button onClick={openAuth} variant="contained" size="large" color="secondary">Get started</Button>
					</div>
				</div>
			</section>
		    <section id="desc">
		    ...
		    <section id="intro">
				...
				<div id="intromessage"> 
					...
					<Button onClick={openAuth} variant="contained" color="secondary">Create an Account</Button>
				</div>
			</section>
			<footer>
