...
export default function Signup(props) {
	return (
		<div className="signupcontainer">
		    ...
		    <Button variant="contained" size="large" color="primary" disableElevation>Create Account</Button>
			<p style={{color: "red"}}>This app does not run ads, your data is entirely yours and will not be shared with any third party.</p>
		</div>
	)
}
